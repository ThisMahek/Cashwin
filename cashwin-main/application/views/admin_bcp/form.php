                    ...
                    <div class="ibox-body">
                        <form class="form-horizontal" id="form-sample-1" method="post" novalidate="novalidate">
                            <div class="form-group row has-error">
                                ...
                                <div class="col-sm-10">
                                    <input name="name" class="form-control" aria-invalid="true" type="text"><label class="help-block error" id="name-error" for="name">This field is required.</label>
                                </div>
                            </div>
                            ...
                            <div class="form-group row has-error">
                                ...
                                <div class="col-sm-10">
                                    <input name="url" class="form-control" aria-invalid="true" type="text"><label class="help-block error" id="url-error" for="url">This field is required.</label>
                                </div>
                            </div>
                            <div class="form-group row">
