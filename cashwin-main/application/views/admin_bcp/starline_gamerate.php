                ...
                <div class="ibox">
                    <div class="ibox-body">
                       <div class="row" style="padding-bottom: 7px;">
                          <div class="col-md-6">
                          <h5 class="font-strong mb-4">List Starline Game Rate</h5></div>
                          <div class="col-md-6">
                              <?php
                        ...
                        <div class="table-responsive row">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $g->starline_points ?></td>
                                        ...
                                        <div class="modal-header pd-y-20 pd-x-25">
                                          ...
                                          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <div class="modal-body ">
                                                ...
                                                <div class="row">
                                                    <input type="text" class="form-control" placeholder="Enter Game Rate" name="rate" value="<?php echo $g->starline_points;?>">
                                                </div><!-- row -->
                                              ` </div>
                                            </div>
