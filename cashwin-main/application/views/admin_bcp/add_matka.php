                                 ...
                                 <!-- <div class="col-sm-8"> -->
                                       ...
                                       <form action="<?=base_url()?>admin/add_matka" method="post">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="time" name="stime" class="form-control"  placeholder=" Bid Start Time" required>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-sm-2 col-form-label">End Time(Mon - Fri)</label>
                                            <div class="col-sm-10">
                                                <input type="time" name="etime" class="form-control" placeholder="Bid End Time" required>
                                            </div>
                                        </div>
                                        <!--<div class="form-group row">-->
