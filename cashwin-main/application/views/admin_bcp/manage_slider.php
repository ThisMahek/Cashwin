                ...
                <div class="ibox">
                    <div class="ibox-body">
                       <div class="row" style="padding-bottom: 7px;">
                          <div class="col-md-6">
                          <h5 class="font-strong mb-4">Manage Slider</h5></div>
                          <div class="col-md-6">
                            ...
                            <table class="table table-bordered table-hover" id="datatable">
                                ...
                                foreach($manage_slider as $post) : ?>
                                 <tr>
                                    ...
                                    <td><img src="<?= base_url()?><?= $post['image']?>"></td>                                   
                                    <td>
                                        <?php if($post['status']=="1"): ?>
                                        <button class="btn-sm btn-primary" onclick="deactivate(<?= $post['id'] ?>)">Active</button>
                                        <?php else: ?>
                                        <button class="btn-sm btn-danger" onclick="activate(<?= $post['id'] ?>)">Inactive</button>
                                        <?php endif; ?>
                                    </td>
                                    <td><a class="btn btn-success" data-toggle="modal" data-target="#modaldemo<?php echo $post['id'] ?>" >Edit</a></td>
                                            ...
                                            <div class="modal-body card-body extra-details">
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-10">
                                                        ...
                                                        <img src="<?= base_url()?><?= $post['image']?>" alt="" id="image0" height="100px">
                                                    </div>
                                                </div>
                                            </div>
