                ...
                <div class="ibox">
                    <div class="ibox-body">
                       <div class="row" style="padding-bottom: 7px;">
                          <div class="col-md-6">
                          <h5 class="font-strong mb-4">Starline List</h5></div>
                          <div class="col-md-6">
                                ...
                                ?>
                                 <tr>
                                   <td><?php echo $post['id']; ?></td>
                                    <td><?php echo $post['s_game_time']; ?></td>
                                    <td><?php echo $post['s_game_end_time']; ?></td>
                                     <td><?php echo $post['s_game_number']; ?></td>

                                  <td>
                                      <a class="btn btn-primary" href='<?php echo base_url(); ?>admin/starline_update/<?php echo $post['id']; ?>'>Edit</a>
                                  </td>
