                ...
                <div class="ibox flex-1">
                    <div class="ibox-body">
                        <div class="flexbox">
                            <div class="flexbox-b">
                                <div class="ml-5 mr-5">
                                    <a data-toggle="modal" data-target="#exampleModal"><img class="img-circle" src="<?php echo base_url()?>assets/resources/img/users/u7.jpg" title="click to edit profile" alt="image" width="110" /></a>
                                </div>
                                <div>
                                    <h4>Admin Name</h4>
                        ...
                        <div class="ibox">
                            <form action="">
                                ...
                                <div class="ibox-footer">
                                    <a href="<?php echo base_url()?>/Admin1/edit_profile"><button class="btn btn-danger mr-2" type="button">Edit</button></a>
