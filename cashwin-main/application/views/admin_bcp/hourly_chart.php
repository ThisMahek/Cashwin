   ...
   <div class="ibox">
      <div class="ibox-body">
         <div class="row" style="padding-bottom: 7px;">
            ...
            <div class="col-md-2">
               <button class="btn btn-info btn-square" data-toggle="modal" data-target="#exampleModalCenter">+Add</button>
            </div>
         </div>
               ...
               <tbody>
                  ...
                  <tr>
                     ...
                     <td style="display: flex;">
                        ...
                        <button type="submit" class="btn btn-danger btn-icon-only btn-circle btn-sm btn-air" name="remove" onclick="return confirm('Are you sure you want to delete?')"> <i class="la la-trash"></i> </button>
                     </td>
                 </tr>
      ...
      <div class="modal-content">
         ...
         <div class="modal-footer">
            ...
            <button type="submit" name="update_Chart" value="<?= $chart->id ?>" class="btn btn-primary">Submit</button>
         </div>
