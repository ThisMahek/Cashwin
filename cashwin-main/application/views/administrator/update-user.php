        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                <div class="card-header">
                    <h5>Update User -- <small style="text-decoration: underline;">
                ...
                <div class="card-block">
                    <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input type="text" id="dropper-default" value="<?php echo $user['dob']; ?>" name="dob"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="checkbox" value="<?php echo $user['status']; ?>" name="status"
                                    class="js-single" <?php if ($user['status'] == '1') {
                                        echo "checked";
                                    } ?> />
                            </div>
                        </div>
