...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item">
                <a href="<?php echo base_url(); ?>administrator/matka/list">Matka</a>
            </li>
            <li class="breadcrumb-item">
                <a href="<?php echo base_url(); ?>administrator/matka/add">Add Matka</a>
            </li>
        </ul>
    </div>
</div>
                            ...
                            <tbody>
                                <?php foreach ($teams as $team): ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $team['bid_start_time']; ?>
                                        </td>
                                        <td>
                                            <?php echo $team['bid_end_time']; ?>
                                        </td>
                                        <td>
                                        ...
                                        <td>
                                            <a class="label label-inverse-info"
                                                href='<?php echo base_url(); ?>administrator/view_games/<?php echo $team['id']; ?>'>Games</a>
                                            <a class="label label-inverse-info"
                                                href='<?php echo base_url(); ?>administrator/view_point_lists/<?php echo $team['id']; ?>'>Points</a>
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
