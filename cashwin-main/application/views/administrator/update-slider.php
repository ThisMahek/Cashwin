                ...
                <div class="card-block">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <input type="text" name="title" value="<?php echo $sliders['title']; ?>"
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-10">
                                <textarea name="description" class="form-control"
                                    placeholder="Description"><?php echo $sliders['description']; ?></textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Current Slider Image</label>
                            <div class="col-sm-6">
                                <img src="<?php echo base_url(); ?>assets/images/sliders/<?php echo $sliders['image']; ?>"
                                    width="100px">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="checkbox" value="1" <?php if ($sliders['status'] == 1) {
                                    echo "checked";
                                } ?>
                                    name="status" class="js-single" />
                            </div>
                        </div>
