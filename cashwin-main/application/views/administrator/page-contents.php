                    ...
                    <tbody>
                        <?php foreach ($pagecontents as $posts): ?>
                            <tr>
                                ...
                                <td><a
                                        href="<?php echo base_url(); ?>administrator/page-contents/update/<?php echo $posts['id']; ?>"><?php echo $posts['page_name']; ?></a></td>
                                <td>
                                    <a class="label label-inverse-info"
                                        href='<?php echo base_url(); ?>administrator/page-contents/update/<?php echo $posts['id']; ?>'>Edit</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
