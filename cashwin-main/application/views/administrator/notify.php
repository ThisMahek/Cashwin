...
<div class="page-header">
    ...
    <div class="page-header-breadcrumb">
        <ul class="breadcrumb-title">
            ...
            <li class="breadcrumb-item"><a href="<?php echo base_url(); ?>administrator/add_wallet">Add Notification</a>
            </li>
        </ul>
    </div>
</div>
        ...
        <div class="col-sm-12">
            ...
            <div class="card">
                ...
                <div class="card-block">
                    ...
                    <!-- <div class="col-sm-8"> -->
                    <?php echo form_open_multipart('administrator/notify2'); ?>

                    <div class="form-group row">
                        <label class="col-sm-2 col-form-label">Enter New Notification</label>
                        <div class="col-sm-10">
