...
input[type=number]::-webkit-outer-spin-button { 
    ...
    margin: 0; 
            ...
            <!-- Page body start -->
            <div class="page-body">
            <div style="color:green; "> <h5><?php echo $this->session->flashdata('fail'); ?></h5></div>
                <div class="row">
                    <div class="col-sm-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-block">
                             ...
                             <!-- <div class="col-sm-8"> -->
                               <?php echo form_open_multipart('administrator/chart_add'); ?>
                 ...
                 <?php }
                    ?>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-10">
                                            <input type="date" name="date" value="<?php echo $transaction['date'] ?>" class="form-control" placeholder="Enter Date">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-3">
                                            <input type="number" oninput="sum1()" id="snum" value="<?php echo $transaction['starting_num'] ?>" name="snum" max="999" class="form-control" placeholder="Starting Number">
                                            </div>
                                            <div class="col-sm-2">
                                            <input type="text" name="num"  id="number" max="99" value="<?php echo $transaction['result_num'] ?>" class="form-control" placeholder="Number">
                                            </div>
                                            <div class="col-sm-3">
                                            <input type="number" oninput="sum1()" value="<?php echo $transaction['end_num'] ?>" id="enum" name="enum" max="999" class="form-control" placeholder="End Number">
