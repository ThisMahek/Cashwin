...
<!--pana logic end-->
                                ...
                                <?php foreach ($single_digit_array as $sda) {
                                        if (in_array($sda, $sd_arr)) {
                                                foreach ($single_digit as $sdrr) {
                                                        if ($sda == $sdrr->digits) { ?>
                                                                                <th scope="col"><div class="points"><?= $sdrr->points; ?></div></th>
                                                                    <?php }
                                                }
                                        } else { ?>
                                                        <th scope="col"><div class="points"><?= 0; ?></div></th>
                                            <?php } ?>
                    ...
                    <!--new single pana design-->
                        <?php if (isset($single_pana) && $single_pana != "") { ?>
                                    <h4 class="heading-border">Single Pana</h4>
                                            <div class="break-table" >
                                               <table class="table table-bordered custum-responsive">
                                                  <thead>
                                                     <tr>
                    ...
                    <!--new double pana design-->
                        <?php if (isset($double_pana) && $double_pana != "") { ?>
                                    <h4 class="heading-border">Double Pana</h4>
                                            <div class="break-table" >
                                               <table class="table table-bordered custum-responsive">
                                                  <thead>
                                                     <tr>
                    ...
                    <!--new Tripal pana design-->
                        <?php if (isset($triple_pana) && $triple_pana != "") { ?>
                                    <h4 class="heading-border">Tripal Pana</h4>
                                            <div class="break-table" >
                                               <table class="table table-bordered custum-responsive">
                                                  <thead>
                                                     <tr>
