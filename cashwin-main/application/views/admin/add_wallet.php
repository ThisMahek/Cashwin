    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-body">
                ...
                <?php echo form_open_multipart('admin/add_wallet2'); ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            <label>Enter Mobile Number</label>
                            <input type="text" name="no" class="form-control" value="<?= $user_mobile ?>"
                                required="required">
                        </div>
                    ...
                    <div class="col-md-12">
                        <div class="form-group mb-4">
                            <label>Points to be Added</label>
