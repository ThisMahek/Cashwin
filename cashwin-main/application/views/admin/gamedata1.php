                ...
                <div class="ibox">
                    <div class="ibox-body pb-0">
                       ...
                       <div class="row" style="padding-bottom: 7px;">
                          <div class="col-md-6">
                          <h5 class="font-strong mb-4">Bid history report</h5></div>
                          <div class="col-md-6">
                          </div>
                       </div>
                         <div class="row">
                        ...
                        <form action="" method="get">
                           ...
                           <select id="game" name="game" class="form-control">
                              ...
                              <?php endforeach; ?>
                                ...
                                <div class="col-md-3">
                                <label>Date</label>
                                <input class="form-control" name="from" type="date" value="<?= ($from)?:date('Y-m-d'); ?>" min="2020-01-01" max="2040-12-31"  required>
                                </div>
