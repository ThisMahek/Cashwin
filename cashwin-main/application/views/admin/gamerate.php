        ...
        <div class="ibox">
            <div class="ibox-body">
                <div class="row" style="padding-bottom: 7px;">
                    <div class="col-md-8">
                        <h5 class="font-strong mb-4">Game Rate</h5>
                    </div>
                    <div class="col-md-4">
                        <?php
                        ...
                        <tbody>
                            ...
                            foreach ($games as $g):
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <?php echo $g->starline_points ?>
                                    </td>
                                    <td><a class="btn btn-success" data-toggle="modal"
                                            data-target="#modaldemo<?= $g->game_id; ?>">Edit</a></td>
                                </tr>
                                    ...
                                    <div class="modal-dialog" role="document">
                                        <div class="modal-content bd-0 tx-14">
                                            <div class="modal-header pd-y-20 pd-x-25">
                                                <h5 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Update Game Rate
                                                </h5>
                                            ...
                                            <form method="post" action="">
                                                <div class="modal-body">
                                                    <div class="form-layout form-layout-4">
                                                        <div class="">
                                                            <lable>Game Rate</lable>
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter Game Rate" name="game_rate"
                                                                value="<?php echo $g->points; ?>">
                                                            <lable>Startline Game Rate</lable>
                                                            <input type="text" class="form-control"
                                                                placeholder="Enter Game Rate" name="starline_rate"
                                                                value="<?php echo $g->starline_points; ?>">
                                                        </div><!-- row -->
                                                        <button type="submit"
                                                            onclick="return confirm('Are you sure to update game rate?');"
                                                            class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium"
                                                            name="update" value="<?= $g->game_id; ?>">Update</button>
                                                        `
                                                    </div>
                                                </div>
