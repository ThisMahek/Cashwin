           ...
           <div class="row">
               ...
               <div class="col-md-6">
                   <label>Player Name</label>
                    <br>
                    <input type="text" required class="form-control" name="player_name" id="player_name" value="<?php if ($select_user != '') {
                        echo $select_user;
                    } else {
