                            ...
                            <div class="flexbox">
                                <form style="display : inline-flex">
                                    ...
                                    <!--    <option value="<?= $matka1->name ?>"><?= $matka1->name; ?></option>-->
                                        <?php //} ?>
                                    <!--</select>-->
                                    <label class="mb-0 mr-2">Bet Type:</label>
                                    <select class="selectpicker show-tick form-control" id="type-bettype" name="bettype" title="Please select" data-style="btn-solid" data-width="150px">
                                        ...
                                        <td><?php
                                             ...
                                             ?>
                                              <form action="" method="get">
                                                 ...
                                                 <button class="btn-no" type="submit"><?= $gamedata->name ?></button>
                                             </form>
                                        </td>
