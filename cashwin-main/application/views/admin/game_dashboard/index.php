...
.text-muted{
  ...
  <div class="content-wrapper">
       <div class="page-heading">
                <h1 class="page-title">Game Dashboard : <?= ($matka->id>20)?'Starline '.$matka->s_game_time:$matka->name ?></h1>
            </div>
            <!-- START PAGE CONTENT-->
            <div class="page-content fade-in-up">
                <div class="row mb-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?= base_url('admin/view_games/'.$matka->id);?>">
                            <div class="card mb-4">
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?= base_url('admin/view_point_lists/'.$matka->id);?>">
                            <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                <div class="easypie mr-4 pr-4" data-percent="50" data-bar-color="#5c6bc0" data-size="90" data-line-width="10">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?= base_url('admin/gamedata?matka_id='.$matka->id);?>">
                            <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                <div class="easypie mr-4 pr-4" data-percent="50" data-bar-color="#5c6bc0" data-size="90" data-line-width="10">
                                </div>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <a href="<?= base_url('Game_dashboard/singleGameData/'.$matka->id.'/open')?>">
                            <div class="card mb-4">
                            <div class="card-body flexbox-b">
                                <div class="easypie mr-4 pr-4" data-percent="50" data-bar-color="#5c6bc0" data-size="90" data-line-width="10">
                                </div>
