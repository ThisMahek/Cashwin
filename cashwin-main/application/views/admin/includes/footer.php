  ...
  $( function() {
    ...
    function reverse_win_amt(date,matkaid,bet_type,reverse_amt_type,pending_status,cancel_status,delete_status){
        updateResult(0);
        var confirm_opt = confirm("Are you sure you want to revert amount?");
        if(confirm_opt == false){
            return false;
        }
        $.ajax({       
          method   : "POST",
          url    : "<?= base_url();?>admin/reverse_game/",
          data   : {matkaid : matkaid,date:date,bet_type:bet_type,reverse_amt_type:reverse_amt_type,pending_status:pending_status,cancel_status:cancel_status,delete_status:delete_status},
          //console.log(data);
