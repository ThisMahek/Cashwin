...
<div class="content-wrapper">
    ...
    <div class="page-heading">
        <div class="ibox">
            <br>
            <h6 class="page-title">User :
                <?php echo $user->name . " (" . $user->mobileno . ")" ?>
            </h6>
            <h6><a href="<?php echo base_url(); ?>UserDashboard/<?php echo $uid; ?>"
                    style="float:right; color:#1abc9c">BACK TO DASHBOARD</a></h6>
                        ...
                        <tbody>
                            <?php foreach ($users as $post): ?>
                                <tr>
                                    ...
                                    <td>
                                        <?php echo abs($post->request_points); ?>
                                    </td>
                                    <td>
                                        <?php echo date('Y-m-d h:i A', strtotime($post->time)); ?>
                                    </td>
                                    <td>
                                        <?php echo ($post->request_status == 'approved') ? "Approved" : "Pending"; ?>
                                    </td>
                                </tr>
                            <?php endforeach; ?>
