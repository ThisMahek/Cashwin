        ...
        <div class="ibox">
            <div class="ibox-body">
                <div class="row" style="padding-bottom: 7px;">
                    <div class="col-md-6">
                        <h5 class="font-strong mb-4">List Player</h5>
                    </div>
                    <div class="col-md-6">
                        ...
                        <tbody>
                            <?php foreach ($users as $post): ?>
                                <tr>
                                    ...
                                    <td><a
                                            href='<?php echo base_url(); ?>admin/view_history/?matka_id=<?php echo $matka_id; ?>&game_id=<?php echo $game_id; ?>&user_id=<?php echo $post['id']; ?>'><span
                                                class="badge badge-success">See history</span></a></td>
