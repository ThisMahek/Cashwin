                ...
                <div class="ibox">
                    <div class="ibox-body">
                       ...
                       <div class="row" style="padding-bottom: 7px;">
                          ...
                          <h5 class="font-strong mb-4">Winning Report</h5></div>
                          <div class="col-md-6 col-6">
                            ...
                            <div class="">
                                ...
                                <div class="row">
                                    <div class="col-md-3 mb-2">
                                        ...
                                        <select id="matka" name="matka_id" class="form-control selectpiker mb-2" style="width:100%">
                                    ...
                                    <div class="col-md-3 mb-2">
                                            <label class="mb-2 mr-2">Bet Type:</label>
                                             <select class="selectpicker show-tick form-control w-100" id="type-bettype" name="bettype" title="Please select" data-style="btn-solid" data-width="150px">
                                               <?php
                                            ...
                                            <?php }else{?>
                                            <option value="open" <?php echo ($type=="open")?"selected":"" ?>>Open</option>
                                            <option value="close" <?php echo ($type=="close")?"selected":"" ?>>Close</option>
                                            <?php }?>
