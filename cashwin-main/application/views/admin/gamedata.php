    ...
    <div class="page-content fade-in-up">
        <div class="ibox">
            <div class="ibox-body">
                    ...
                    <div class="">
                        <form style="">
                            ...
                            <div class="row">
                                ...
                                if ($game_type == 'game') {
                                    ...
                                    <div class="col-md-2 mb-2">
                                        ...
                                        <select class="selectpicker show-tick form-control w-100" id="type-bettype"
                                            name="bettype" title="Please select" onchange="selectpana(this.value)"
                                ...
                                ?>
                                <div class="col-md-3 mb-2" id="open">
                                    <label class="mb-0 mr-2 mb-2">Open Pana:</label>
                                    <select id="matka" name="winning_ank" class="selectpicker show-tick form-control">
                                        ...
                                        for ($i = 1; $i <= 10; $i++) {
                                            for ($j = $i; $j <= 10; $j++) {
                                                for ($k = $j; $k <= 10; $k++) {
                                                    ...
                                                    //   foreach($arr as $arro): 
                                                    ?>
                                                    <option value="<?php echo $arr ?>" <?php echo ($winning_ank == $arr) ? "selected" : "" ?>>
                                                        <?php echo $arr; ?></option>
                                ...
                                <div class="col-md-3 mb-2" id="close" style="display:none;">
                                    <label class="mb-0 mr-2 mb-2">Close Pana:</label>
                                    <select id="matka" name="winning_ank_close"
                ...
                <div class="col-12">
                    <button class="btn btn-default">Total Bid Amount : Rs.
                        <?= isset($bid_amount) ? $bid_amount : "0"; ?>
                    </button>
                    <button class="btn btn-default">Total Winning Amount : Rs.
                        <?= isset($pot) ? $pot : "0"; ?>
                    </button>
