    ...
    <div class="ibox">
      <div class="ibox-body">
        <div class="row" style="padding-bottom: 7px;">
          <div class="col-md-6">
            <h5 class="font-strong mb-4">Withdraw Report</h5>
          </div>
          <div class="col-md-6">
          ...
          <table class="table table-bordered table-hover" id="datatable">
            ...
            <tbody>
              ...
              foreach ($users as $post):
                ...
                <tr
                  style='<?= ($post['request_status'] == "cancel") ? "" : (($post['request_status'] == "pending") ? "background:yellow;" : ""); ?>'>
                  <td>
                    <?php echo $i; ?>
                  </td>
                  <td>
                  ...
                  <td>
                    <?php
                    if ($post['request_status'] == 'approved') {
                      echo "<span style='color:green'> Approved</span>";

                    } elseif ($post['request_status'] == 'cancel') {
                  ...
                  <!---<td>
                                            ...
                                            <a href='<?php echo base_url(); ?>admin/withdraw_point_req2/<?php echo $post['request_id']; ?>'>
                                                <a class="btn btn-success" data-toggle="modal" href="#approveModal<?php echo $post['request_id']; ?>">Apporve</a>
